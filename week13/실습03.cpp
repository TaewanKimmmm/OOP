//(실습3)아래는 bubble sort 방식으로 정수를 정렬하는 프로그램입니다.프로그램을 분석해
//보고, bubble_sort의 인자로 입력되는 Compare comp를 위한* Functor를 구현해 보시오.
//comp의 입력(compLess / compGreater)에 따라 오름차순과 / 내림차순으로 각각 다르게
//정렬됩니다.
...
////Fuctor인 compGreater를 구현하세요. (힌트: 1. 두 정수 비교 결과를 bool 타입을 리턴한다.
...
////Fuctor인 compLess를 구현하세요. (힌트: 1. 두 정수 비교 결과를 bool 타입을 리턴한다. 2.
